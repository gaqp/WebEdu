...
export default class Cadastro extends Component {
    ...
    componentDidMount() {
        switch (this.props.role) {
            case ("diretor"):
                this.setState({ role: "diretor", step: 1, titleName: "Adicionar" })
                break;
            case ("aluno"):
                this.setState({ role: "aluno", step: 1, titleName: "Adicionar" })
                break;
            case ("jovem_ace"):
                this.setState({ role: "jovem_ace", step: 1, titleName: "Adicionar" })
                break;
            case ("professor"):
                this.setState({ role: "professor", step: 1, titleName: "Adicionar" })
                break;
            case ("profissional_educacao"):
                this.setState({ role: "profissional_educacao", step: 1, titleName: "Adicionar" })
                break;

            case ("profissional_saude"):
                this.setState({ role: "profissional_saude", step: 1, titleName: "Adicionar" })
                break;

            case ("pesquisador"):
                this.setState({ role: "pesquisador", step: 1, titleName: "Adicionar" })
                break;

            case ("administrador"):
                this.setState({ role: "administrador", step: 1, titleName: "Adicionar" })
                break;
            default:
                break;
    ...
    render() {
        ...
        if (this.state.step === 0) {
            return (
                <React.Fragment>
                    <h1><span id="cadTitle">{this.state.titleName} </span></h1>
